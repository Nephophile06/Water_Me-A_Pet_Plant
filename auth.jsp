<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <title>Grow With Time - Welcome to Your Garden Sanctuary</title>
    ...
    <body class="nature-sky-bg min-h-screen flex items-center justify-center p-4 sm:p-6 relative select-none">
        ...
        <main class="clay-card max-w-[430px] w-full p-7 sm:p-9 relative z-20 text-center transition-all duration-300">

            <!-- Top Cute Header Badge -->
            <div
                class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#EAF6EE] border border-[#C5E9D3] text-[#247E49] text-xs font-bold tracking-wide mb-4 shadow-sm">
                <span class="gentle-bounce inline-block text-sm">🌱</span>
                <span id="cardBadge">Grow With Time</span>
            </div>
            ...
            <div
                ...
                <svg width="40" height="40" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- Right Leaf -->
                    <path d="M24 15C32 15 34 8 31 5C28 2 24 9 24 15Z" fill="#48BB78" stroke="#226B3D" stroke-width="1.5"
                        stroke-linejoin="round" />
                    <!-- Tiny Flower/Sparkle -->
            ...
            <h1 class="text-2xl sm:text-3xl font-extrabold font-['Quicksand'] text-[#163824] mb-1 tracking-tight"
                id="authTitle">Welcome Back</h1>
            <p class="text-xs text-[#527963] mb-5 font-semibold leading-relaxed" id="authSubtitle">Log in to enter your
                personal greenhouse</p>
            ...
            <form action="loginAction.jsp" method="POST" class="space-y-4 text-left">
                ...
                <div>
                    <label
                        ...
                        <svg class="w-3.5 h-3.5 text-[#36925B]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="relative">
                        <input type="text" name="username" required autocomplete="username" placeholder="e.g., anika"
                            ...
                            <%= "invalid_credentials" .equals(err) ? "Incorrect username or password!" : "" %>
                                <%= "user_exists" .equals(err) ? "Username is already taken. Try another!" : "" %>
                                    <%= "invalid_input" .equals(err) ? "Please fill in all the required fields." : "" %>
                                        <%= "server_error" .equals(err) ? "Database or server error. Please try again!"
                                            : "" %>
                        </span>
                    </div>
                    <% } %>
                        ...
                        <button type="submit" id="authSubmitBtn"
                            ...
                            <span id="authSubmitBtnText">Enter Greenhouse</span>
            ...
            <div
                ...
                <span id="authToggleText">New gardener here?</span>
            ...
            <div class="mt-3.5 text-[11px] text-[#6E9880] font-semibold" id="plantGreeting">
                🌿 Mindful habit tracking through virtual botanical care
            </div>
        </main>
